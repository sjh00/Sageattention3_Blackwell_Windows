...
struct CollectiveMainloopFwd {
    ...
    struct Params {
        ...
        // Natural alignment of TMA descriptors (required by prefetch_tma_descriptor on Windows).
        // Using alignas(TMA_*) rather than a fixed 64: some toolchains reject lower-than-default alignas.
        alignas(TMA_Q) TMA_Q tma_load_Q;
        alignas(TMA_SFQ) TMA_SFQ tma_load_SFQ;
        alignas(TMA_KV) TMA_KV tma_load_K;
        alignas(TMA_SFKV) TMA_SFKV tma_load_SFK;
        alignas(TMA_Vt) TMA_Vt tma_load_Vt;
        alignas(TMA_SFVt) TMA_SFVt tma_load_SFVt;
        alignas(TMA_DS) TMA_DS tma_load_DS;
        float const softmax_scale_log2;
    };
